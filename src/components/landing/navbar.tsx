  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[1030] w-full transition-all duration-300">
      <div className="container mx-auto px-4 mt-4 lg:mt-4">
          <div 
            className={`flex items-center justify-between mx-auto max-w-[1320px] transition-all duration-300 rounded-[1920px] px-[9.6px] py-[8px] bg-background/80 backdrop-blur-md shadow-[0_30px_60px_0_rgba(0,0,0,0.3)] ${
          ...
          >
            ...
            <div className="flex items-center pl-4 lg:pl-0">
              <a href="#" className="flex items-center group">
                ...
                <span className="font-serif text-[19.2px] font-bold text-foreground transition-colors group-hover:text-primary pr-2">
                  PV Plumbing
                </span>
              </a>
            </div>
              ...
              <ul className="flex items-center gap-2">
                {navLinks.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="font-serif text-[19.2px] text-foreground px-4 py-4 rounded-[16px] hover:bg-white/5 transition-all"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          {isMenuOpen && (
            <div className="lg:hidden absolute top-[110px] left-4 right-4 bg-background/95 backdrop-blur-lg rounded-[20px] p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                {navLinks.map((link) => (
                  <li key={link.name}>
                    <a
                      ...
                      className="block font-serif text-[22px] text-foreground p-3 text-center"
                    >
                      {link.name}
                    </a>
                  </li>
