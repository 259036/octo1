...
const NewsBlog = () => {
  ...
  return (
      <section 
        ...
        className="bg-background py-[100px] md:py-[60px]"
      >
        <div className="container mx-auto px-4 max-w-[1320px]">
          {/* Section Header */}
          <div className="text-center mb-16 md:mb-10">
            <h2 className="font-display text-[48px] md:text-[36px] font-bold text-foreground mb-0">
              Latest From PV
            </h2>
          </div>
            ...
            {blogPosts.map((post, index) => (
              <div key={index} className="flex flex-col h-full">
                ...
                <div className="flex flex-col flex-grow">
                  <h3 className="font-display text-[24px] md:text-[20px] font-bold text-foreground mb-2 leading-tight">
                    {post.title}
                  </h3>
                  ...
                  <p className="font-sans text-[17.6px] text-foreground/90 mb-6 line-clamp-3 leading-[1.6]">
                    {post.description}
                  </p>
                  ...
                  <div className="mt-auto">
                    <a
                      href="#"
                      className="inline-flex items-center justify-center bg-[#eed36d] text-black font-semibold text-[14.4px] px-8 py-3 rounded-full uppercase tracking-wide hover:bg-[#dec45a] transition-colors focus:ring-2 focus:ring-[#eed36d] focus:ring-offset-2"
                    >
                      Read
                    </a>
                  </div>
