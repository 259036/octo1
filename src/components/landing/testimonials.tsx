...
export default function Testimonials() {
  ...
  return (
      <section className="bg-background py-[60px] md:py-[100px] overflow-hidden" id="testimonials-1-v5Azpn48Cg">
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <div className="max-w-2xl mx-auto px-4">
                      <p className="font-display text-[24px] md:text-[32px] leading-[1.2] font-bold text-foreground mb-8 italic">
                        &ldquo;{testimonial.quote}&rdquo;
                      </p>
                      <div className="font-sans">
                        <h5 className="text-[19.2px] font-semibold text-foreground mb-1">
                          {testimonial.author}
                        </h5>
                        <p className="text-[17.6px] text-foreground/80 mb-0">
                          {testimonial.role}
                        </p>
                      </div>
                    </div>
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === activeIndex ? "bg-[#eed36d] scale-125" : "bg-white/20"
                  }`}
